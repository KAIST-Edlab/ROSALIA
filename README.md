...
1. **Lack of flexible interaction:** Existing vision-language modles (VLMs) often perform segmentation on a single lesion type and cannot adapt to simple user-provided instructions.
